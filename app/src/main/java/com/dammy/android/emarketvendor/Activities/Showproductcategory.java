...
public class Showproductcategory extends AppCompatActivity {
    ...
    private void showloadingdialog() {
        loadingdialog = new Dialog(Showproductcategory.this, android.R.style.Theme_Light);
        ...
        Glide.with(Showproductcategory.this).load(R.drawable.loading).into(imageViewTarget);
