...
public class newOrderuserInfo extends AppCompatActivity {
    ...
    private void showloadingdialog() {
        loadingdialog = new Dialog(newOrderuserInfo.this, android.R.style.Theme_Light);
        ...
        Glide.with(newOrderuserInfo.this).load(R.drawable.loading).into(imageViewTarget);
